# Public Key
Represents a EUREKACOIN public key and is needed to be able to receive EUREKACOIN, as is usually represented as a EUREKACOIN [Address](address.md). 

A PublicKey in eurekacoincore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK = eurekacoincore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new eurekacoincore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = eurekacoincore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
